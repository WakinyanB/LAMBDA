...
simul_data_FACS <- read.csv("Data/Simulated_data/simul_data_FACS_4.csv", header = TRUE)
simul_data_qPCR <- read.csv("Data/Simulated_data/simul_data_qPCR_4.csv", header = TRUE)
...
write.csv(estim_df, "Outputs_csv/Estim_nmk_parallel_simulated_data_sd_noise_05_timestep_1_n5x2000_seed123_v11.csv", row.names = FALSE)