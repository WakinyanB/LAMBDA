...
estim_df <- Estim_nmk_parallel(parms0=parms0, constants=c("alpha_w"=estim_alpha_exp[["alpha_w"]], "alpha_m"=estim_alpha_exp[["alpha_m"]], "B"=B),
			       data_FACS=data_FACS, data_qPCR=data_qPCR,
                               maxfeval=4000, Ncores=35)
Sys.time()-t0

write.csv(estim_df, paste0("Outputs_csv/Estim_nmk_parallel_experimental_data_nstarts", n_starts, "_B", B, "_v11.csv"), row.names = FALSE)